...
<head>
    ...
    <title>ADMIN | Pawsome admin Quary</title>
  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><img src="images/logo.jpg"  width="15% "/> Pawsome</h4></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Dogs <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="update_cnp.php"> Update Dog </a></li>
                            </ul>
                        </li>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2021 Pawsome. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
